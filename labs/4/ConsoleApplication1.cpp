...
string XOR(string &str1, string &str2)
{
    ...
    {
        counter = str1.size() / str2.size();
    }
    else
    {
        counter = str1.size() / str2.size() + 1;
    }
    while (counter > 0)
    {
...
void Encrypt()
{
    ...
    string str;
    getline(cin, str);
    string text = highRegister(str);
    cout << "Введите ключ, состоящий из 8 символов: ";
    string key;
    getline(cin, key);
    cout << "Введите вектор, состоящий из 8 символов: ";
    string vector;
    getline(cin, vector);
    ...
    for (int k = 0; k < (text.length() / 8); k++)
    {
        ...
        //обратном порядке 
        string result = encryption(vector);
        decrypted += result;
    }
